...
data class Stadium (
    ...
    @Column(nullable = false) @Min(value = 500, message = "capacity of a stadium should not be less than 500") var capacity: Double,
    ...
    @OneToMany(mappedBy = "stadium", fetch = FetchType.EAGER) var matches: List<Match>? = listOf()
}